...
export default function TagModal({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-30 overflow-y-auto h-full w-full z-50">
      <div className="relative top-10 mx-auto p-8 max-w-2xl w-11/12 shadow-2xl rounded-2xl bg-white dark:bg-gray-800">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              maxLength={10}
              pattern="[A-Z0-9]*"
              className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all font-mono dark:bg-gray-900 dark:text-gray-100 ${
                errors.tagCode
                  ? "border-red-500 focus:ring-red-500"
                  : "border-gray-300 dark:border-gray-700"
              }`}
