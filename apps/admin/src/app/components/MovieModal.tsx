    ...
    const fetchCountries = async () => {
      ...
      try {
        ...
        const response = await fetch(
          "http://localhost:4000/v1/admin/countries?page=1&limit=1000&sortBy=name&sortOrder=asc",
          {
            headers: {
  ...
  useEffect(() => {
    const fetchGenres = async () => {
      ...
      try {
        ...
        const response = await fetch(
          "http://localhost:4000/v1/admin/genres?page=1&limit=1000&sortBy=genreName&sortOrder=asc",
          {
            headers: {
              Authorization: `Bearer ${token}`,
              "Content-Type": "application/json",
  ...
  useEffect(() => {
    const fetchTags = async () => {
      ...
      try {
        ...
        const response = await fetch(
          "http://localhost:4000/v1/admin/tags?page=1&limit=1000&sortBy=tagName&sortOrder=asc",
          {
            headers: {
              Authorization: `Bearer ${token}`,
              "Content-Type": "application/json",
  ...
  useEffect(() => {
    const fetchCast = async () => {
      ...
      try {
        ...
        const response = await fetch(
          "http://localhost:4000/v1/admin/cast?page=1&limit=1000&sortBy=castName&sortOrder=asc",
          {
            headers: {
              Authorization: `Bearer ${token}`,
              "Content-Type": "application/json",
