        ...
        <div style={{
          ...
          <div style={{justifySelf: 'end', display: 'flex', gap: '10px'}}>
            ...
            <button style={{
              ...
              cursor: 'pointer',
              fontSize: '20px'
            }} onClick={onClose} aria-label="ปิดเมนู">
              ✕
            </button>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div className="menu-quick">
              {/* โปรโมชั่น */}
              <a className="quick quick--promo" href="https://ezcasino.ai/promotions" target="_blank" rel="noopener nofollow">
